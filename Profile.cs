...
namespace KeyCounter
{
    ...
    public static class ProfileManager
    {
        ...
        public static Profile SelectProfile(string profileName)
        {
            ...
            foreach (var VARIABLE in profile.GamepadKeys)
            {
                Console.Write("{0}   {1} \n", VARIABLE.Key,VARIABLE.Value);
            }

            Console.WriteLine("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
            foreach (var VARIABLE in profile.TotalKeys)
            {
                Console.Write("${0}$   ${1}$ \n", VARIABLE.Key, VARIABLE.Value);
            }
            Console.WriteLine(profile.TotalKeys.ContainsKey("RightThumbRight"));
            Console.WriteLine("\n\n\n\n\n\n\n");
            ...
            foreach (string key in keys)
            {
                ...
                {
                    profile.GamepadKeys.Dictionary[key].ReplaceImage(GamepadImages.GetImageForKey(key));
